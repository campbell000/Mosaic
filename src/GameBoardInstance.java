...
public class GameBoardInstance extends JFrame {
	...
	private Container createContent() {
        ...
        GameBoardComponent theGameBoard = new GameBoardComponent();
        CurrentHandComponent theCurrentHand = new CurrentHandComponent();
        ...
        JButton buttonTilesLeft = new JButton();
        ...
        userPotentialScore.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 102, 102), 1));
        ...
        **/
        ...
        buttonDouble.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	 buttonDoubleActionPerformed(evt);
            }
        });
       ...
       // panelLoginLayout.setAutoCreateContainerGaps(true);
        ...
        layout.setHorizontalGroup(
        		layout.createSequentialGroup()
        			...
        			.addGroup(layout.createParallelGroup()
                		...
                		.addGroup(layout.createSequentialGroup()
                				.addGap(60)
                				.addComponent(buttonMenu, 110,110 ,110)
                				.addGap(20)
                				.addComponent(buttonForfeit, 110 ,110, 110)
                				)
                		.addGroup(layout.createSequentialGroup()	
                				.addComponent(buttonLogo, 380, 380, 380)
                				)
                	 )
                	.addGap(30)
                	.addGroup(layout.createParallelGroup()
                			...
                			.addGroup(layout.createSequentialGroup()
	                			...
	                			.addGap(30)
	                			.addComponent(buttonDouble, 60, 60, 60)
                			)
        			)
        );//setHorizontalGroup
        ...
        layout.setVerticalGroup(
    			...
    			.addGroup(layout.createSequentialGroup()
                		...
                		.addGap(30)
                		.addGroup(layout.createParallelGroup()
                				.addComponent(buttonMenu, 50,50 ,50)
     			...
     			.addGroup(layout.createSequentialGroup()
                		...
                		.addGroup(layout.createParallelGroup()
                				.addGroup(layout.createSequentialGroup()
                						.addGap(7)
                						.addComponent(theCurrentHand, 45, 45, 45)
	                			)
	                			.addComponent(buttonPlay)
	                			.addComponent(buttonSwap, 60, 60, 60)
	                			.addComponent(buttonDouble, 60, 60, 60)
        ...
        windowlayout.setHorizontalGroup(
            ...
            .addComponent(panelGameBoard, GroupLayout.DEFAULT_SIZE, 784, Short.MAX_VALUE)
        );
        windowlayout.setVerticalGroup(
            windowlayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(panelGameBoard, GroupLayout.DEFAULT_SIZE, 444, Short.MAX_VALUE)
        );
	 ...
	 * @return
	 */
	protected void buttonForfeitActionPerformed(ActionEvent evt) {
	 ...
	 * @return
	 */
	protected void buttonDoubleActionPerformed(ActionEvent evt) 
   {
		
      int userSelection;
		
		// ------------------------------------------------ ARMANDO WAS HERE -----------------------------------------------------------------------
		userSelection = JOptionPane.showConfirmDialog(null, "Are you sure you want to double the value of the Game", "Double the game?", JOptionPane.YES_NO_OPTION);
	 ...
	 * @return
	 */
	protected void buttonMenuActionPerformed(ActionEvent evt) 
   {
      Home_Screen homescreen = new Home_Screen();
		dispose();
	 ...
	 * @return
	 */
	protected void buttonPlayActionPerformed(ActionEvent evt) {
	...
	private class BettingPopUp extends JFrame{
		...
		private Container createBettingContent() {
			...
			labelBanner.setIcon(new ImageIcon(getClass().getResource("resources/bettingbanner.jpg")));
	       ...
	       // panelLoginLayout.setAutoCreateContainerGaps(true);
	        ...
	        panelBettingLayout.setHorizontalGroup(
	        		panelBettingLayout.createParallelGroup()
	        			.addComponent(labelBanner, 500, 500, 500)
        				.addGroup(panelBettingLayout.createSequentialGroup()
        						.addGap(120)
        						.addComponent(textBetAmount, 250, 250 ,250)
            			)
        				.addGroup(panelBettingLayout.createSequentialGroup()
        						.addGap(120)
        						.addComponent(buttonSub, 125, 125, 125)
        						.addGap(0)
        						.addComponent(buttonAdd, 125, 125, 125)
            			)
            			.addGroup(panelBettingLayout.createSequentialGroup()
        						.addGap(150)
	        ...
	        windowlayout.setHorizontalGroup(
	            windowlayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
	            .addComponent(panelBetting, GroupLayout.DEFAULT_SIZE, 450, Short.MAX_VALUE)
	        );
	        windowlayout.setVerticalGroup(
	            windowlayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
	            .addComponent(panelBetting, GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
	        );
...
//360, 90
			...
			labelWinner.setIcon(new ImageIcon(getClass().getResource("resources/winnerBanner.jpg")));
			
			labelLoser.setIcon(new ImageIcon(getClass().getResource("resources/loserBanner.jpg")));
			
			labelStats.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(51, 51, 51), 2));
	       ...
	       // panelLoginLayout.setAutoCreateContainerGaps(true);
	        ...
	        windowlayout.setHorizontalGroup(
	            windowlayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
	            .addComponent(winingPanel, GroupLayout.DEFAULT_SIZE, 650, Short.MAX_VALUE)
	        );
	        windowlayout.setVerticalGroup(
	            windowlayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
	            .addComponent(winingPanel, GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
	        );
